...
class Point:
    def __init__(self, x=0, y=0):
        # 1. Überprüft, ob x und y numerisch sind.
    ...
    def randomize(self, max):
        # Generiert zufällige Werte für x und y (bis max) und speichert diese ab.
    ...
    def get_distance(self, to_point):
        ...
        # 3. Falls nein: Diese Zeile wird ausgeführt (ohne Anführungszeichen): 'raise ValueError'
    ...
    def get_angle(self, to_point):
        # 1. Prüft, ob to_point vom Typ Point ist
        # 2. Falls ja: Berechnet den Winkel, der eine Linie vom Punkt zu to_point
        # 3. Falls nein: Diese Zeile wird ausgeführt (ohne Anführungszeichen): 'raise ValueError'
...
class Polygon:
    ...
    def add_point(self, point):
        ...
        # 3. Falls nein: Führt 'raise ValueError' aus
